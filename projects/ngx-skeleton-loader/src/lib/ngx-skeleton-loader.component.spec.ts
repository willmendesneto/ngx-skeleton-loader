...
@Component({
  ...
  template: `
    <div>
      ...
      <div class="skeletons-appearance-customContent">
        <ngx-skeleton-loader appearance="customContent">
...
describe('NgxSkeletonLoaderComponent', () => {
  ...
  describe('When the component uses default configuration', () => {
    ...
    describe('When skeleton is created with customContent appearance', () => {
      it('should use the content inside', () => {
        expect(fixture.nativeElement.querySelector('.skeletons-appearance-customContent .loader.customContent').innerHTML.length).toBeGreaterThan(0);
      });
    });
